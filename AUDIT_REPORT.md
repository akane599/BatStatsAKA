...
## Remaining work
1. Await explicit publication/validation approval to use prepared hardware-accelerated CI. Local software-emulator attempts are exhausted for this checkpoint; retained AVD can be retried without Gradle. No phone is required.
