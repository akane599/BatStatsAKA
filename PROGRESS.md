...
## Exact next action
1. Stage5a validated (commit containing this checkpoint); commit/reread, then fix B31 source-specific collection errors and B30 same-millisecond capture matching. Add JVM and Android recovery regressions before API36 UI/Shizuku checks.
